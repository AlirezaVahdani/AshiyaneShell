...
echo "<style>#aboutus{background: #A81F1F}</style>";
        ...
        <span>Greetings  : Behrooz_Ice, Commander_AV, C4T, Alireza, Hror, Milad Hacking, ACC3SS, T3rm!nat0r5, Alireza Attacker, H_SQLI EMpiRe, .NetRemoting, Spoofer, spoof, All Ashiyane Members And Madleets.</span><br />
